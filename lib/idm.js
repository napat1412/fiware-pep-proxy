...
const IDM = (function() {
  ...
  const checkToken = function(
    ...
    if (action && resource) {
      ...
      path = path + '&app_id=' + applicationID;
    } else if (authzforce) {
      ...
      if (cachedUserInfo) {
        ...
        proxy.sendData(
          ...
          function(status, resp) {
            ...
            if (!checkOrganizations(organizations, organizationToken)) {
            ...
            // To implementation Central PEP Proxy cluster,
            // Disable Application ID verification per PEP Proxy
            /* else if (!checkApplication(userInfo.app_id)) {
              log.error(
